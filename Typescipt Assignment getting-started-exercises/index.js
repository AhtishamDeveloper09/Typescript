...
let favPizzas = ["BBQ Chicken", "Pepperoni", "Veggie"];
...
let animalNames = ["Cat", "Dog", "Parrots"];
...
let magiciansNames = ["Babar", "Ali", "Hamza", "Usama", "Ahsan"];
...
let magiciansNames2 = ["Babar", "Ali", "Hamza", "Usama", "Ahsan"];
function make_great(magiciansNames2) {
    let greatMagicians = [];
...
let copyOfMagiciansNames = ["Babar", "Ali", "Hamza", "Usama", "Ahsan"];
