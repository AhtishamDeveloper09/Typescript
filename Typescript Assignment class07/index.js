...
function removeEvenNumbers(arrayOfNumbers2) {
...
function areaOfCircle(radiusOfCircle) {
    let calcualateArea = Math.PI * radiusOfCircle ** 2;
...
let listOfGrades = [60, 45, 75, 53, 35, 48, 77, 28, 84, 96];
function removeFailingGrades(listOfGrades) {
    for (let i = 0; i < arrayOfNumbers2.length; i++) {
...
let arrayOfNumbers3 = [60, 45, 75, 53, 35, 48, 77, 28, 84, 96];
function findLargestElement(arrayOfNumbers3) {
    let largest = arrayOfNumbers3[0];
